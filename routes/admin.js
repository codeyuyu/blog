 ...
 */
var fs = require('fs');
var util = require('../com/util.js');
var config = require('../config.js').config;
var userDao = require('../dal/user.js');
var postDao = require('../dal/post.js');
var pageDao = require('../dal/page.js');
var commentDao = require('../dal/comment.js');
